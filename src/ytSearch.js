...
if(!options.channels.includes(message.channel.id)) throw new Error("This channel isn't added to the list of allowed channels, kindly contact developer for more info.")
